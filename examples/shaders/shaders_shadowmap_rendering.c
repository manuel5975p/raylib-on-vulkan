...
int main(void)
{
    ...
    Shader shadowShader = LoadShader("resources/shaders/vk/shadowmap.vert.spv",
                                     "resources/shaders/vk/shadowmap.frag.spv");
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        // PASS 02: Draw the scene into main framebuffer, using the generated shadowmap
            ...
            // NOTE: rlvk binds samplers by shader binding index (set 1), not by GL
            // texture unit: pass the texture id straight to the sampler location
            rlSetUniformSampler(shadowMapLoc, shadowMap.depth.id);
