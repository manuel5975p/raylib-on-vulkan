...
int main(void)
{
    ...
    Shader shader = LoadShader(
        "resources/shaders/vk/vertex_displacement.vert.spv",
        "resources/shaders/vk/vertex_displacement.frag.spv");
    ...
    // NOTE: rlvk binds samplers by shader binding index (set 1) and takes the texture
    // id directly, there is no GL texture-unit indirection
    rlEnableShader(shader.id);
    rlSetUniformSampler(perlinNoiseMapLoc, perlinNoiseMap.id);
