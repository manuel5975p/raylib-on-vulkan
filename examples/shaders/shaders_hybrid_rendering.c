...
int main(void)
{
    ...
    Shader shdrRaymarch = LoadShader("resources/shaders/vk/default.vert.spv", "resources/shaders/vk/hybrid_raymarch.frag.spv");

    // This Shader is a standard rasterization fragment shader with the addition of depth writing
    // You are required to write depth for all shaders if one shader does it
    Shader shdrRaster = LoadShader("resources/shaders/vk/default.vert.spv", "resources/shaders/vk/hybrid_raster.frag.spv");
