...
int main(void)
{
    ...
    Shader celShader = LoadShader(
        "resources/shaders/vk/cel.vert.spv",
        "resources/shaders/vk/cel.frag.spv");
    ...
    Shader outlineShader = LoadShader(
        "resources/shaders/vk/outline_hull.vert.spv",
        "resources/shaders/vk/outline_hull.frag.spv");
        ...
        BeginDrawing();
            ...
            BeginMode3D(camera);
                ...
                if (outlineEnabled)
                {
                    ...
                    rlSetCullFace(0);     // rlvk: rlSetCullFace takes 0 = front, 1 = back
