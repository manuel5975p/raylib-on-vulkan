...
// api.md compatibility aliases for functions renamed upstream
RLAPI Vector2 GetSplinePointBezierQuad(Vector2 p1, Vector2 c2, Vector2 p3, float t);  // Alias of GetSplinePointBezierQuadratic
RLAPI void ImageDraw(Image *dst, Image src, Rectangle srcRec, Rectangle dstRec, Color tint); // Alias of ImageDrawImagePro (origin 0, rotation 0)
RLAPI void ImageDrawTriangleEx(Image *dst, Vector2 v1, Vector2 v2, Vector2 v3, Color c1, Color c2, Color c3); // Alias of ImageDrawTriangleGradient
